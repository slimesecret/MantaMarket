...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $action === 'delete' && $id) {
    ...
    header("Location: /MantaMarket/sellers/index.php?page=brands");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $action === 'insert') {
    ...
    if ($checkSlug) {
        header("Location: /MantaMarket/sellers/index.php?page=brands&error=slug");
        exit();
    }
...
const imgHtml = c.logo_url
    ...
    function submitBraForm() {
        ...
        fetch('/MantaMarket/sellers/index.php?page=brands', { method: 'POST', body: data })
